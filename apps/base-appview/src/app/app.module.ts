...
import { DeleteFill, DeleteOutline, EditFill, EditOutline, LinkOutline, PlusOutline, SaveOutline } from '@ant-design/icons-angular/icons';
...
const icons: IconDefinition[] = [
  PlusOutline, EditOutline, DeleteOutline, LinkOutline, EditFill, DeleteFill, SaveOutline
];
